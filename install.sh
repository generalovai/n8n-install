...
# =============================================================================
# Эта строка намеренно латиницей: если у человека в терминале сбита кодировка
# (обычно это старый cmd.exe в Windows), весь русский текст ниже превратится
# в мусор - и только по ней он поймёт, что делать.
printf '%s\n' "If the text below looks broken - close this window and use Windows Terminal."
